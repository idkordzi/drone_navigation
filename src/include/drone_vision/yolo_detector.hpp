...
constexpr float CONFIDENCE_THRESHOLD = 0.4f; // Confidence threshold for filtering detections
constexpr float IOU_THRESHOLD = 0.45f;       // IoU threshold for filtering detections
